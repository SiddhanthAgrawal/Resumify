...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {State University, \textit{City, State}}{Sep. 2017 -- May 2021}
      {Bachelor of Science in Computer Science}{Cumulative GPA : 4.00/4.00}
    \resumeItemListStart
        \resumeItem{\textbf{Relevant Coursework}}{: Computing and Informatics Design, Introduction to Computer Science, Computer Programming II, Calculus (I - IV), Linear Algebra}
         \resumeItemListEnd
